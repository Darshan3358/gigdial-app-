                ...
                builder: (context) {
                  return Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ListTile(
                          leading: const Icon(Icons.favorite_border, color: AppTheme.primaryBlue),
                          title: const Text('Add to Favorites', style: TextStyle(fontWeight: FontWeight.w600, color: AppTheme.textDark)),
                          onTap: () {
                            Navigator.pop(context);
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text('${worker.name} added to favorites!'),
                        ...
                        ListTile(
                          ...
                          title: const Text('Block Worker', style: TextStyle(fontWeight: FontWeight.w600, color: Colors.red)),
                          onTap: () {
                            Navigator.pop(context);
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text('${worker.name} has been blocked.'),
                                duration: const Duration(seconds: 2),
                              ),
                            );
                          },
                        ...
                        ListTile(
                          ...
                          title: const Text('Report Worker', style: TextStyle(fontWeight: FontWeight.w600, color: AppTheme.textDark)),
                          onTap: () {
                            Navigator.pop(context);
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text('Thank you! Report filed against ${worker.name}.'),
                                duration: const Duration(seconds: 2),
                              ),
                            );
                          },
