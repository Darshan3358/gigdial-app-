                        ...
                        children: [
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                Text(
                                  isPending ? 'Pending Acceptance' : (lead.status == 'Completed' ? 'Job Completed' : 'Job in Progress (${lead.status})'),
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          const Divider(height: 16),
                          _buildDetailRow('Total Amount', '₹${lead.price.toStringAsFixed(0)}'),
                          const Divider(height: 16),
                      ...
                      children: [
                        ...
                        Expanded(
                          child: ElevatedButton(
                            onPressed: () {
                              setState(() {
                                BookingState().updateBookingStatus(lead.id, 'Accepted');
                              });
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                        ...
                        Expanded(
                          child: OutlinedButton(
                            onPressed: () {
                              setState(() {
                                BookingState().updateBookingStatus(lead.id, 'Cancelled');
                              });
                      ...
                      children: [
                        if (lead.status == 'Accepted')
                          ElevatedButton(
                            onPressed: () {
                              setState(() {
                                BookingState().updateBookingStatus(lead.id, 'On the Way');
                              });
                            },
                            style: ElevatedButton.styleFrom(
                        ...
                        if (lead.status == 'On the Way')
                          ElevatedButton(
                            onPressed: () {
                              setState(() {
                                BookingState().updateBookingStatus(lead.id, 'In Progress');
                              });
                            },
                            style: ElevatedButton.styleFrom(
                              backgroundColor: Colors.teal,
                        ...
                        if (lead.status == 'Accepted' || lead.status == 'On the Way' || lead.status == 'In Progress') ...[
                          const SizedBox(height: 8),
                          TextButton(
                            onPressed: () {
                              setState(() {
